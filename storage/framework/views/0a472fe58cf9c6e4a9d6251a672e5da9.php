...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('categorys.index')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('product-review.index')); ?>" class="nav-link">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\shopping\resources\views/partials/siderbar.blade.php ENDPATH**/ ?>